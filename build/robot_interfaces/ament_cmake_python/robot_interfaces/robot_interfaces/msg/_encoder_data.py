    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'robot_interfaces.msg.EncoderData')
            logger.debug(
...
class EncoderData(metaclass=Metaclass_EncoderData):
    ...
    def __init__(self, **kwargs):
        ...
        self.velocity_estimate = kwargs.get('velocity_estimate', float())
    ...
    def __eq__(self, other):
        ...
        if self.distance != other.distance:
            return False
        if self.velocity_estimate != other.velocity_estimate:
            return False
        return True
    ...
    def ticks(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'ticks' field must be an integer in [-2147483648, 2147483647]"
        self._ticks = value
    ...
    def velocity_estimate(self):
        """Message field 'velocity_estimate'."""
        return self._velocity_estimate

    @velocity_estimate.setter
    def velocity_estimate(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'velocity_estimate' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'velocity_estimate' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._velocity_estimate = value
