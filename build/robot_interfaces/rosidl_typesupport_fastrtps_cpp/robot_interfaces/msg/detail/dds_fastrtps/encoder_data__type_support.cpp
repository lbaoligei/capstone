...
#include "robot_interfaces/msg/detail/encoder_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_interfaces::msg::EncoderData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_interfaces::msg::EncoderData & ros_message)
{
  // Member: ticks
  cdr >> ros_message.ticks;
...
{
  auto typed_message =
    static_cast<const robot_interfaces::msg::EncoderData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_interfaces::msg::EncoderData *>(
    untyped_ros_message);
...
{
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_EncoderData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_interfaces, msg, EncoderData)() {
  return &robot_interfaces::msg::typesupport_fastrtps_cpp::_EncoderData__handle;
}
