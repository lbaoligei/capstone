...
#include "robot_interfaces/msg/detail/encoder_data__rosidl_typesupport_fastrtps_c.h"
...
using _EncoderData__ros_msg_type = robot_interfaces__msg__EncoderData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: velocity_estimate
  {
    cdr << ros_message->velocity_estimate;
  }
...
size_t get_serialized_size_robot_interfaces__msg__EncoderData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name velocity_estimate
  {
    size_t item_size = sizeof(ros_message->velocity_estimate);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _EncoderData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_interfaces__msg__EncoderData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robot_interfaces
size_t max_serialized_size_robot_interfaces__msg__EncoderData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _EncoderData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_interfaces__msg__EncoderData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_interfaces, msg, EncoderData)() {
