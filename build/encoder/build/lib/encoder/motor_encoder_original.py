...
class MotorEncoder(Node):
    ...
    def __init__(self):
        ...
        self.encoder_publisher_ = self.create_publisher(Int64, 'encoder_data', 10)
        timer_period = 0.1 #encoder_data is published every "timer_period" seconds
        self.encoder_timer_ = self.create_timer(timer_period, self.publish_encoder)
