...
class ControllerNode(Node):
    def __init__(self):
        ...
        self.buttons = {'x':0.,'o':0.,'t':0.,'s':0.,'L1':0.,'R1':0.,'L2':0.,'R2':0.,'share':0.,'options':0.,
           'axis1':0.,'axis2':0.,'axis3':0.,'axis4':0.,'Dpad up':0,'Dpad down':0, 'Dpad left':0,'Dpad right':0,'L3':0,'R3':0}
        self.left_stick_x = 0.
        self.left_stick_y = 0.
...
#             print(event.dict,event.joy,event.button,'RELEASED')
                ...
                #print()
                joy_msg.buttons = [round(self.buttons[key]) for key in ['Dpad up','Dpad down','Dpad left','Dpad right','x','o','t','s','L1', 'R1','L2','R2','share','options','L3','R3']]
